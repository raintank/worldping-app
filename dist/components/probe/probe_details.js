...
function () {
  ...
  _createClass(ProbeDetailsCtrl, [{
    ...
    value: function gotoDashboard(probe) {
      this.$location.path("/dashboard/db/worldping-probes").search({
        "var-probe": probe.slug,
        "var-endpoint": "All"
      });
    }
  }, {
...
exports.ProbeDetailsCtrl = ProbeDetailsCtrl;
